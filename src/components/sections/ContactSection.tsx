              ...
              {details.map((item) => (
                <li key={item.label}>
                  ...
                  {item.href ? (
                    <a
                      href={item.href}
                      className="mt-1 inline-block text-base text-[#1a1714] underline-offset-4 transition hover:text-[#ed7d24] hover:underline"
                    >
                      {item.value}
                    </a>
                  ) : (
            ...
            >
              <div className="grid gap-5 sm:grid-cols-2">
                <label className="block">
                  ...
                  <input
                    ...
                    name="name"
                    autoComplete="name"
                    className="w-full border border-black/12 bg-white px-4 py-3 text-sm text-[#1a1714] outline-none transition focus:border-[#ed7d24]/60 focus:ring-2 focus:ring-[#ed7d24]/15"
                  />
                </label>
                <label className="block">
                  <span className="mb-2 block text-xs font-medium tracking-wide text-black/50 uppercase">
              ...
              <label className="block">
                ...
                <textarea
                  name="message"
                  rows={4}
                  className="w-full resize-y border border-black/12 bg-white px-4 py-3 text-sm text-[#1a1714] outline-none transition focus:border-[#ed7d24]/60 focus:ring-2 focus:ring-[#ed7d24]/15"
                />
              </label>
              <button
                type="submit"
                className="inline-flex items-center justify-center rounded-full bg-[#ed7d24] px-8 py-3.5 text-sm font-medium text-white transition hover:bg-[#d66e1a] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#ed7d24] focus-visible:ring-offset-2 focus-visible:ring-offset-[#f6f3ec]"
              >
                {form.submitLabel}
              </button>
            </form>
